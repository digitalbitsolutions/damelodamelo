...
<head>
    ...
    <meta name="author" content="Dámelo Dámelo">

    <?= $this->renderSection("css") ?>
</head>
<body>
    <div class="loader-page-change" id="loader-page-change">
        <img src="<?= base_url()."img/damelo_damelo_icon.webp" ?>" alt="Dámelo Dámelo">
    </div>
    <header class="header-app">
        <div class="logo">
            <a href="<?= base_url() ?>" aria-label="Dámelo Dámelo">
                <img src="<?= base_url()."img/damelo_damelo.webp" ?>" alt="Dámelo Dámelo">
            </a>
        </div>
    ...
    <footer class="footer" style="padding-top: 0.6rem;">
        ...
        <div class="row-images">
            <img src="<?= base_url()."img/footer_1.webp" ?>" class="img_1" alt="damelo damelo">
            ...
            <img src="<?= base_url()."img/ucrania_1.webp" ?>" class="img_3" alt="damelo damelo ucrania">
        </div>
        <div class="container-row-3">
            <h3>© 2024 Dámelo Dámelo Tablón de anuncios inmobiliario particulares y profesionales gratis.</h3>
            <div class="container-imgs">
                <img src="<?= base_url()."img/google_play.webp" ?>" class="img_1" alt="damelo damelo google play">
                <img src="<?= base_url()."img/app_store.webp" ?>" class="img_2" alt="damelo damelo app store">
            </div>
        </div>
        <div id="cookieBanner" class="cookie-banner hide">
            <img src="<?= base_url("img/cookie-monster-clipart-24.webp") ?>" class="img-cookie" alt="cookie damelo damelo">
            <h1>COOKIES</h1>
