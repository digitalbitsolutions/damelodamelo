    ...
    <div class="container-main">
        ...
        <div class="container-row-form box">
            <div class="div-col-1">
                ...
                <label for="">
                    <span class="title-label">Número de documento *</span>
            ...
            <div class="div-col-1">
                <label for="">
                    <span class="title-label">Móvil (WhatsApp) *</span>
                    <input type="text" class="input" name="phone" required>
                </label>
                <label for="">
                    <span class="title-label">Teléfono fijo</span>
                    <input type="text" class="input" name="landline_phone">
                </label>
            </div>
            <label for="">
                <span class="title-label">E-mail *</span>
                <input type="email" class="input" value="" name="email" required autocomplete="off">
            </label>
            <label for="">
                <span class="title-label">Dirección *</span>
            ...
            <label for="" class="div-col-1">
                <span class="title-label">Contraseña *</span>
                <div class="container-controls-cont">
                    <button type="button" class="icon is-left" id="generate-password">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 32 32"><path fill="#ffffff" d="M21 2a8.998 8.998 0 0 0-8.612 11.612L2 24v6h6l10.388-10.388A9 9 0 1 0 21 2m0 16a7 7 0 0 1-2.032-.302l-1.147-.348l-.847.847l-3.181 3.181L12.414 20L11 21.414l1.379 1.379l-1.586 1.586L9.414 23L8 24.414l1.379 1.379L7.172 28H4v-3.172l9.802-9.802l.848-.847l-.348-1.147A7 7 0 1 1 21 18"/><circle cx="22" cy="10" r="2" fill="#ffffff"/></svg>
                    </button>
        ...
        <!-- <h2 class="title-main-row-section">Detalles servicio</h2> -->
        <div class="container-row-form box">
            ...
            <label for="">
                ...
                <input type="text" class="input" placeholder="" name="page_url">
            </label>
        </div>
        ...
        <div class="container-row-form-col-1 box">
            ...
            <!-- <div class="div-col-1">
                <span class="title-label">Localidad de acción *</span>
                <?php foreach($locationAction as $la){ ?>
                <label class="radio label-radio-checkbox-col-100">
                    <input type="checkbox" class="checkbox-input-ui" hidden="" name="location_action[]" value="<?= $la["id"] ?>" />
                    <span class="checkmark-checkbox-input-ui"></span>
                    <?= $la["name"] ?>
                </label>
                <?php } ?>
...
<script>
    ...
    document_type.addEventListener("change", ()=>{
        if (document_type.value === "cif"){
            ...
            document.querySelector(".container-label-last_name").querySelector("input").setAttribute("disabled", true);
            ...
            document.querySelector(".container-label-last_name").querySelector("input").removeAttribute("disabled");
            document.querySelector(".container-label-last_name").querySelector("span").style.textDecoration = "auto";
    ...
    const button_view_password = document.getElementById("view-password");
    ...
    document.getElementById("generate-password").addEventListener("click", ()=> {generarPassword(); input_pass.type = "text"; });

    button_view_password.addEventListener("click", ()=>{
        if (button_view_password.dataset.hidden === "hidden"){
            button_view_password.dataset.hidden = "show";
            input_pass.type = "password";
        }else{
            button_view_password.dataset.hidden = "hidden";
